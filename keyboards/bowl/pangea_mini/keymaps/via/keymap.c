...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * └────┴────┴────┴────────────────────────┴──────┴────┴───────┘
     */
    [0] = LAYOUT_60_ansi_split_right_shift(
    ...
    [1] = LAYOUT_60_ansi_split_right_shift(
    ...
    _______, _______, KC_VOLD, KC_MUTE, KC_VOLU, _______, _______, KC_MPRV, KC_MPLY, KC_MNXT, _______, _______,         KC_PSCR,
