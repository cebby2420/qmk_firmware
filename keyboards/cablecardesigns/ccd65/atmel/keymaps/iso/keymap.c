...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_MA] = LAYOUT(
    ...
    KC_LSFT,KC_NUBS, KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,   KC_M,KC_COMM, KC_DOT,KC_SLSH,KC_RSFT,KC_UP,         MO(_F1), \
    KC_LCTL,KC_LGUI,KC_LALT,                 KC_SPC,                        KC_RALT,KC_RALT,             KC_LEFT,KC_DOWN,KC_RGHT),
